...
class TerbaruPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: const _TerbaruWidget(),
    );
  }
}

class _TerbaruWidget extends StatefulWidget {
  const _TerbaruWidget({Key? key}) : super(key: key);

  @override
  __TerbaruWidgetState createState() => __TerbaruWidgetState();
}

class __TerbaruWidgetState extends State<_TerbaruWidget> {
  @override
  Widget build(BuildContext context) {
                    ...
                    Container(
                      ...
                      child: const Row(
                        children: [
                          ...
                          Padding(
                            padding: EdgeInsets.only(
                                left: 152), // Jarak 30 ke sisi kiri
                            child: Row(
                              children: [
                                Text(
                ...
                children: [
                  ...
                  Padding(
                    ...
                    child: Container(
                      ...
                      padding: const EdgeInsets.symmetric(vertical: 0),
                      decoration: BoxDecoration(
                        color: const Color.fromARGB(255, 255, 255, 255), // Change to the desired color
                        borderRadius: BorderRadius.circular(15),
                      ),
                      child: Row(
                        mainAxisSize: MainAxisSize.max,
                        children: [
                          Container(
                            width:
                                370, // Set the width of the image container to 100
                            height:
                                100, // Set the height of the image container to 100
                            decoration: BoxDecoration(
                              image: const DecorationImage(
                                image: AssetImage(
                                    'assets/1.jpg'), // Replace with the image path
                                fit: BoxFit.cover,
                              ),
                              borderRadius: BorderRadius.circular(15),
                            ),
