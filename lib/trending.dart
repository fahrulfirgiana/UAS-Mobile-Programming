...
class TrendingPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: const _TrendingWidget(),
    );
  }
}

class _TrendingWidget extends StatefulWidget {
  const _TrendingWidget({Key? key}) : super(key: key);

  @override
  __TrendingWidgetState createState() => __TrendingWidgetState();
}

class __TrendingWidgetState extends State<_TrendingWidget> {
  @override
  Widget build(BuildContext context) {
                    ...
                    Container(
                      ...
                      child: const Row(
                        children: [
                          ...
                          Padding(
                            padding: EdgeInsets.only(
                                left: 140), // Jarak 30 ke sisi kiri
                            child: Row(
                              children: [
                                Text(
                              ...
                              children: [
                                Container(
                                  ...
                                  child: ClipRRect(
                                    borderRadius: BorderRadius.circular(15),
                                    child: Image.asset(
                                      'assets/paulo.jpeg', // Ubah dengan path gambar yang diinginkan
                                      fit: BoxFit.cover,
                                    ),
                                  ),
                                ),
                                                  ...
                                                  Padding(
                                                    padding: EdgeInsets.only(
                                                        ...
                                                        top:
                                                            10), // Jarak kiri dan atas pada teks judul
                                                    child: Text(
                                                      'Masih Cedera, Dybala Bisa Ikut Argentina ke Indonesia?', // Isi judul berita
                                                      style: TextStyle(
                                                        color: Color.fromARGB(
                                                            255, 0, 0, 0),
                                                        fontSize: 16,
                              ...
                              children: [
                                Container(
                                  ...
                                  child: ClipRRect(
                                    borderRadius: BorderRadius.circular(15),
                                    child: Image.asset(
                                      'assets/desta.jpeg', // Ubah dengan path gambar yang diinginkan
                                      fit: BoxFit.cover,
                                    ),
                                  ),
                                ),
                                                  ...
                                                  Padding(
                                                    padding: EdgeInsets.only(
                                                        ...
                                                        top:
                                                            10), // Jarak kiri dan atas pada teks judul
                                                    child: Text(
                                                      'Heboh Desta Cabut Gugatan Cerai ke Natasha Rizki', // Isi judul berita
                                                      style: TextStyle(
                                                        color: Color.fromARGB(
                                                            255, 0, 0, 0),
                                                        fontSize: 16,
